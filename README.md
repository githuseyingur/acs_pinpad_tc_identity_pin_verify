...
Since a 6-digit pin will be entered, we need to enter a minimum value of 6 and a maximum value of 6, that is ***0606***, in the ***Pin Extra Digit*** field. The data in the 'abData' section is important. This data is CLA, INS, P1, P2 and L*p* (length of the pin to be entered) respectively. <br><br>
