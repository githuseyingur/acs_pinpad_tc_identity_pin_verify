...
import com.teklifbilisim.tckkreader_mh_hg_sd.TCKKReader;
import com.teklifbilisim.tckkreader_mh_hg_sd.callback.TCKKReaderCallback;
import com.teklifbilisim.tckkreader_mh_hg_sd.device.TCKKCardReaderEventListener;
import com.teklifbilisim.tckkreader_mh_hg_sd.driver.usb.ACSCommandTransmitter;
import com.teklifbilisim.tckkreader_mh_hg_sd.service.TCKKReadingService;
...
import tr.gov.ekds.ekk.api.service.basic.IBasicServiceContainer4Std;
import tr.gov.tubitak.bilgem.uekae.ekds.tckk.api.v2_5.card.asn1.kimlik.Asn1TCKimlikNumarasi;
import tr.gov.tubitak.bilgem.uekae.ekds.tckk.api.v2_5.operational.basic.service.TCKKServiceContainer;
import tr.gov.tubitak.bilgem.uekae.ekds.tckk.api.v2_5.operational.communication.common.iface.IServiceContainer4All;
import tr.gov.tubitak.bilgem.uekae.ekds.tckk.api.v2_5.operational.service.ReadingServiceBase;
import tr.gov.tubitak.bilgem.uekae.ekds.tckk.api.v2_5.operational.service.ServiceContainerBase;

/**
 * Test program for ACS smart card readers.
 *
 * @author Hüseyin Gür & Muhammed Hoşgör & little help : Sedat Dayan
 * @version 1.1.1, 08.08.2023
 */
public class MainActivity extends Activity   {
    ...
    private void connectTckkReader() {
        try {
            ACSCommandTransmitter acsCommandTransmitter = new ACSCommandTransmitter(this);
            //geçti
            TCKKReader  acsTckkReader = new TCKKReader(this, acsCommandTransmitter);
            acsTckkReader.getName(new TCKKReaderCallback<String>() {
                @Override
                ...
                public void error(Exception e) {
                    Toast.makeText(MainActivity.this, "EXXXCEPTIONINONI", Toast.LENGTH_LONG).show();
                }
            });
           //geçti
            acsTckkReader.addEventListener(new TCKKCardReaderEventListener() {
                @Override
                public void cardReaderAttached() {
                    Toast.makeText(MainActivity.this, "cardReaderAttached", Toast.LENGTH_LONG).show();
                    logMsg("cardReaderAttached " + TAG);
                    Log.i(TAG, "cardReaderAttached: ");
                ...
                public void cardReaderDetached() {
                    Toast.makeText(MainActivity.this, "cardReaderDetached", Toast.LENGTH_LONG).show();
                    logMsg("cardReaderDetached: " + TAG);
                    Log.i(TAG, "cardReaderDetached: ");
                }

                @Override
                public void cardInserted() {
                    Toast.makeText(MainActivity.this, "cardInserted", Toast.LENGTH_LONG).show();
                    logMsg("cardInserted: " + TAG);
                    Log.i(TAG, "cardInserted: ");
                }

                @Override
                public void cardRemoved() {
                    Toast.makeText(MainActivity.this, "cardRemoved", Toast.LENGTH_LONG).show();
                    logMsg("cardRemoved: " + TAG);
                    Log.i(TAG, "cardRemoved: ");

                }
            });
            acsCommandTransmitter.open();


        } catch (Exception e) {
            Toast.makeText(MainActivity.this, "ERROR", Toast.LENGTH_LONG).show();

            logMsg("Error in acs: " + e);
            Log.e(TAG, "Error in acs", e);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   mSlotSpinner.setAdapter(mSlotAdapter);
       ...
       // mPowerSpinner.setSelection(Reader.CARD_WARM_RESET);
        ...
        mReaderAdapter.clear(); // DEVICE LİSTESİ ATAMA
        int i = 0;
        for (UsbDevice device : mManager.getDeviceList().values()) {
            if (mReader.isSupported(device)) {
                mReaderAdapter.add(device.getDeviceName());
      ...
      /*  mListButton = (Button) findViewById(R.id.main_button_list);
        mListButton.setOnClickListener(new OnClickListener() { //xx LIST BUTTON ON CLICK
       ...
       /* mOpenButton = (Button) findViewById(R.id.main_button_open);
        mOpenButton.setOnClickListener(new OnClickListener() { //xx OPEN BUTTON ON CLICK
      ...
      //  mOpenButton.setEnabled(false);
        ...
        String deviceName = (String) mReaderAdapter.getItem(0);
      ...
      /*  mCloseButton = (Button) findViewById(R.id.main_button_close);
        mCloseButton.setOnClickListener(new OnClickListener() { //xx CLOSE BUTTON ON CLICK
        ...
        mPowerButton = (Button) findViewById(R.id.main_button_power); //xx POWER BUTTON ON CLICK
            ...
            public void onClick(View v) {
                ...
                if (slotNum != Spinner.INVALID_POSITION) {
                    ...
                    logMsg("Slot " + slotNum
                            ...
                            + transmitParams.controlCode + ")...");
                    new TransmitTask().execute(transmitParams);
                }
                byte[] pinVerifyData = { (byte) 0x00, 0x20, 0x00, 0x01, 0x06 // 80 20 06 00 08 FF FF FF FF FF FF FF FF
                        };

                // Initialize PIN verify structure (ACOS3)
                mPinVerify.setTimeOut(0x1E);
                mPinVerify.setTimeOut2(0x1E);
                mPinVerify.setFormatString(0x82);
                mPinVerify.setPinBlockString(0x00);
                mPinVerify.setPinLengthFormat(0x00);
                mPinVerify.setPinMaxExtraDigit(0x0606);
                mPinVerify.setEntryValidationCondition(0x02);
       ...
       /* mGetAtrButton = (Button) findViewById(R.id.main_button_get_atr);
        mGetAtrButton.setOnClickListener(new OnClickListener() {  //xx GET ATR BUTTON ON CLICK
     ...
     /*   mSetProtocolButton = (Button) findViewById(R.id.main_button_set_protocol);
        mSetProtocolButton.setOnClickListener(new OnClickListener() { //xx SET PROTOCOL BUTTON ON CLICK
      ...
      /*  mGetProtocolButton = (Button) findViewById(R.id.main_button_get_protocol);
        mGetProtocolButton.setOnClickListener(new OnClickListener() { //xx GET PROTOCOL BUTTON ON CLICK
        ...
        mTransmitButton.setOnClickListener(new OnClickListener() {   //xx TRANSMIT BUTTON ON CLICK
        ...
        mControlButton.setOnClickListener(new OnClickListener() { //xx CONTROL BUTTON ON CLICK
        ...
        mGetFeaturesButton.setOnClickListener(new OnClickListener() { //xx GET FEATURES BUTTON ON CLICK
        ...
        mVerifyPinButton.setOnClickListener(new OnClickListener() { //xx VERIFY PIN BUTTON ON CLICK
        ...
        mPinModify.setPinBlockString(0x06);
        mPinModify.setPinLengthFormat(0x06);
        mPinModify.setInsertionOffsetOld(0);
        mPinModify.setInsertionOffsetNew(0);
        mPinModify.setPinMaxExtraDigit(0x0406);
        mPinModify.setConfirmPin(0x01);
        mPinModify.setEntryValidationCondition(0x02);
        ...
        mModifyPinButton.setOnClickListener(new OnClickListener() { //xx MODIFY PIN BUTTON ON CLICK
        ...
        mDisplayLcdMessageButton.setOnClickListener(new OnClickListener() { //xx DISPLAY LCD MSG BUTTON ON CLICK
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (slotNum != Spinner.INVALID_POSITION) {
                                    ...
                                    // Set parameters
                                    TransmitParams params = new TransmitParams();
                                    TransmitParams paramss = new TransmitParams();
                                    params.slotNum = slotNum;
    ...
    private void performPowerAction(PowerParams params) {
        PowerResult result = new PowerResult();
        try {
